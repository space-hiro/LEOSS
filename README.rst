...
The figure above shows the output plot from the line  ``groundTrack(recorder['DIWATA'])``.
The horizontal axis is the longitude ranging from 180° W to 180° E (also -180 to 180). The vertical axis is the geodetic latitude
ranging from 90° S to 90° N (also -90 to 90). This two-dimensional groundtrack shows the predicted track satellite track over a rotating Earth.
...
The instantaneous position (latitude, longitude and altitude) is annotated with the satellite.
The name of the satellite is shown as the title: "DIWATA", the instantaneous datetime is also shown after the satellite name.
